...
class ExampleInputMediaDocument(InputMediaDocument):
    """Example implementation of InputMediaDocument handler"""

    @property
    def __names__(self) -> List[str]:
        """List of trigger names for this handler"""
        return [
            "example_input_media_document",
        ]
    ...
    async def handle(self, update, bot):
        ...
        - update.disable_content_type_detection (bool): Optional. Disables automatic server-side content type detection for files uploaded using multipart/form-data. Always True, if the document is sent as part of an album.
        """
