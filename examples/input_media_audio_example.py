...
class ExampleInputMediaAudio(InputMediaAudio):
    """Example implementation of InputMediaAudio handler"""

    @property
    def __names__(self) -> List[str]:
        """List of trigger names for this handler"""
        return [
            "example_input_media_audio",
        ]
    ...
    async def handle(self, update, bot):
        ...
        - update.caption (str): Optional. Caption of the audio to be sent, 0-1024 characters after entities parsing
        ...
        - update.duration (int): Optional. Duration of the audio in seconds
        - update.performer (str): Optional. Performer of the audio
        - update.title (str): Optional. Title of the audio
        """
