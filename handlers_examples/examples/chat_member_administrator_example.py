...
class ExampleChatMemberAdministrator(ChatMemberAdministrator):
    """Example implementation of ChatMemberAdministrator handler"""

    @property
    def __names__(self) -> List[str]:
        """List of trigger names for this handler"""
        return [
            "example_chat_member_administrator",
        ]
    ...
    async def handle(self, update, bot):
        ...
        - update.status (str): The member's status in the chat, always "administrator"
        - update.user (User): Information about the user
        - update.can_be_edited (bool): True, if the bot is allowed to edit administrator privileges of that user
