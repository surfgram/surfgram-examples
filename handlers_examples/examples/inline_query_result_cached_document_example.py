...
class ExampleInlineQueryResultCachedDocument(InlineQueryResultCachedDocument):
    """Example implementation of InlineQueryResultCachedDocument handler"""

    @property
    def __names__(self) -> List[str]:
        """List of trigger names for this handler"""
        return [
            "example_inline_query_result_cached_document",
        ]
    ...
    async def handle(self, update, bot):
        ...
        - update.document_file_id (str): A valid file identifier for the file
